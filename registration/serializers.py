...
class ParcelSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            raise serializers.ValidationError(
                {"parcel_type_name": "Указанный тип посылки не найден."}
            )
    ...
    def update(self, instance, validated_data):
        ...
        instance.content_value_usd = validated_data.get(
            "content_value_usd", instance.content_value_usd
        )
        instance.parcel_type = parcel_type
        instance.registered_at = validated_data.get(
